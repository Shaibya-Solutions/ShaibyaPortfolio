  ...
  return (
    <main className="bg-slate-950 text-slate-100">
      ...
      <Section className="mt-10">
        ...
        <p className="mt-2 text-sm text-slate-400">A modern catalog inspired by the reference designs.</p>
        <div className="mt-6 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <ServiceCard
            ...
            icon={<FaMobileAlt />}
          />
          <ServiceCard href="/services/rd" title="Custom R&D" desc="Rapid prototyping & PoCs." icon={<FaFlask />} />
        </div>
      </Section>
      ...
      <Section className="mt-12">
        <div className="relative overflow-hidden rounded-2xl border border-slate-800/60 p-6 text-center">
          ...
          <h2 className="font-heading text-2xl text-white">See Shaibya in Action</h2>
          <p className="mx-auto mt-2 max-w-2xl text-sm text-slate-300">
            Predictive operations, automated workflows, and robust platforms that scale with your growth.
          </p>
          <div className="mx-auto mt-6 grid max-w-3xl grid-cols-3 gap-3">
            {[
              ...
              <div key={s.k} className="rounded-xl border border-slate-800/60 bg-slate-950/60 px-4 py-3">
