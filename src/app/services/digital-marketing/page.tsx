    ...
    <main className="min-h-screen flex flex-col bg-white text-slate-900 dark:bg-slate-950 dark:text-slate-100 overflow-x-hidden font-sans">
      ...
      <section className="relative pt-44 pb-32 flex-grow flex items-center justify-center">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          >
            <div className="w-16 h-16 rounded-2xl bg-orange-50 dark:bg-orange-950/40 border border-orange-100 dark:border-orange-900/30 flex items-center justify-center mx-auto mb-8 text-[#f97316]">
            ...
            <p className="text-lg md:text-xl text-slate-500 dark:text-slate-400 font-light max-w-2xl mx-auto mb-10">
              We design and execute custom growth marketing, SEO, and social media suites that put your brand in front of the right audiences and capture leads on autopilot.
            </p>
