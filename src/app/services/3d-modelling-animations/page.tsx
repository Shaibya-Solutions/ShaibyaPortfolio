    ...
    <main className="min-h-screen flex flex-col bg-white text-slate-900 dark:bg-slate-950 dark:text-slate-100 overflow-x-hidden font-sans">
      ...
      <section className="relative pt-44 pb-32 flex-grow flex items-center justify-center">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          >
            <div className="w-16 h-16 rounded-2xl bg-pink-50 dark:bg-pink-950/40 border border-pink-100 dark:border-pink-900/30 flex items-center justify-center mx-auto mb-8 text-[#ec4899]">
            ...
            <p className="text-lg md:text-xl text-slate-500 dark:text-slate-400 font-light max-w-2xl mx-auto mb-10">
              We create immersive 3D models, assets, and cinematic animations that bring ideas to life, elevating visual storytelling across digital platforms.
            </p>
