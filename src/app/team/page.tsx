      ...
      <Section className='mt-12 grid gap-6 md:grid-cols-2'>
        <div>
          <h2 className='mb-3 text-xl font-semibold text-white'>
            Get to Know Our AI Expertise
          </h2>
          <Accordion
            type='single'
            collapsible
            className='rounded-xl border border-slate-800/60 bg-slate-950/60 p-2'
          >
            <AccordionItem value='a1'>
              ...
              <AccordionContent>
                We focus on measurable outcomes: efficiency, revenue, and
                customer experience.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value='a2'>
              ...
              <AccordionContent>
                Discovery, pilot, production—with observability and governance
                built in.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value='a3'>
              ...
              <AccordionContent>
                PoC in weeks, production in phases depending on scope and
                compliance.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
          ...
          <div className='relative grid gap-4'>
            <div className='rounded-lg border border-slate-800/60 bg-slate-950/60 p-4'>
              ...
              <div className='font-heading'>
                Collaborative, inclusive, outcome‑driven
              </div>
            </div>
            <div className='rounded-lg border border-slate-800/60 bg-slate-950/60 p-4'>
              <div className='text-xs text-slate-300'>Principles</div>
              <div className='font-heading'>
                Pragmatism, accessibility, craftsmanship
              </div>
            </div>
          </div>
        </div>
