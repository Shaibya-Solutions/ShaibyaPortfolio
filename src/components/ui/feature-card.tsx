...
export function FeatureCard({
  ...
  return (
    <Link href={href}>
      <div
        className={`group flex flex-col justify-between items-center min-h-[160px] md:min-w-[320px] hover:bg-gradient-to-br hover:from-cyan-500/90 hover:to-white/90 rounded-2xl border border-slate-800/60 bg-gradient-to-b from-blue-950/50 to-slate-950/60 p-5 shadow-[0_0_0_1px_rgba(8,145,178,0.05)_inset] transition hover:border-cyan-600/40 ${className}`}
      >
