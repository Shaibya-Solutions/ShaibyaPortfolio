            ...
            >
              {values.map((v) => {
                ...
                return (
                  ...
                  >
                    <Icon className="w-7 h-7 mb-5 text-[#0ea5e9] group-hover:text-[#38bdf8] transition-colors duration-300" />
                    <h4
            ...
            <div className="space-y-16">
              {timeline.map((item, idx) => {
                ...
                return (
                  ...
                  >
                    {/* Circle icon on vertical timeline line */}
                    <div
                      className="absolute left-4 md:left-1/2 w-8 h-8 rounded-full border-4 -translate-x-[14px] md:-translate-x-4 z-20 flex items-center justify-center bg-[#060d1f]"
