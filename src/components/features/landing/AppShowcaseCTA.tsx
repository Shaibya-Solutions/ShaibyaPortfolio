    ...
    >
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between gap-12 max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          >
            <Image
              src="/images/phone-main.png" // Replace with your main app screenshot
          ...
          >
            <Image
              src="/images/phone-left.png" // Replace with your left app screenshot
          ...
          >
            <Image
              src="/images/phone-right.png" // Replace with your right app screenshot
