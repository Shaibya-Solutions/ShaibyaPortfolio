    ...
    <section className='bg-[#020617] py-16 px-6 md:px-12 lg:px-20'>
      <div className='max-w-6xl mx-auto'>
        ...
        <div className='flex flex-wrap lg:flex-nowrap items-center justify-center gap-8'>
          ...
          <div className='bg-gradient-to-b sm:min-w-[350px] min-h-[160px] from-[#0f172a] to-[#000000] border-2 border-[#0f172a] rounded-2xl p-6 text-start shadow-md'>
            <h3 className='text-3xl sm:text-5xl mb-8 font-bold text-white'>
          ...
          <div className='bg-gradient-to-b sm:min-w-[350px] min-h-[160px] from-[#0f172a] to-[#000000] border-2 border-[#0f172a] rounded-2xl p-6 text-start shadow-md'>
            <h3 className='text-3xl sm:text-5xl mb-8 font-bold text-white'>300%</h3>
            <p className='text-gray-400 text-end mt-2 text-sm'>
